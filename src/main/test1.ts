...
module.exports = function login () {
  ...
  function verifyPreLoginChallenges (req: Request) {
    ...
    challengeUtils.solveIf(challenges.oauthUserPasswordChallenge, () => { return req.body.email === 'bjoern.kimminich@gmail.com' && req.body.password === process.env.OAUTH_CHALLENGE_PASSWORD }) // Fixture credential for security training challenge — load from env; if a real credential was ever committed here, rotate/revoke it immediately.
  }
