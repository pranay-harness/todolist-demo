...
public class Edit extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    if (task == null || priority == null || task.isEmpty() || priority.isEmpty()) {
      ...
      // The destination is a fixed allow-listed page; the date is validated and URL encoded by the helper.
      SafeRedirect.to(getServletContext(), response, SafeRedirect.SHOW_EDIT_TASK_PAGE, "date", date);
    } else {
